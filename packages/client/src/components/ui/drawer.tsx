...
/**
 * Positioning/transform shell for the drawer popup. Opaque `bg-popover` is
 * intentionally omitted — the glass surface lives on Content (`.glass-surface`
 * forces `position: relative` and must not sit on this fixed-position shell).
 */
...
const drawerContentClassName =
  'glass-surface flex min-h-0 flex-1 flex-col overflow-hidden overscroll-contain rounded-[inherit] transition-opacity duration-300 ease-[cubic-bezier(0.45,1.005,0,1.005)] select-text group-data-nested-drawer-open/drawer-popup:opacity-0 group-data-nested-drawer-swiping/drawer-popup:opacity-100 group-data-swiping/drawer-popup:select-none'
    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      >
        ...
        >
          ...
          <DrawerPrimitive.Content data-slot="drawer-content" className={drawerContentClassName}>
            {children}
